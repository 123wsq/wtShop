package com.example.wsq.library.tools.Permissions;
...
//        }
        ...
        try {
            ...
            ToastUtils.onToast("please open this permission");
    ...
    private static void requestMultiResult(Activity activity, String[] permissions, int[] grantResults, PermissionGrant permissionGrant) {
        ...
        if (notGranted.size() == 0) {
            ToastUtils.onToast("all permission success" + notGranted);
    ...
    private static void showMessageOKCancel(final Activity context, String message, DialogInterface.OnClickListener okListener) {
        ...
        builder.setTitle("权限管理")
                .setMessage(message)
                .setOkBtn("确定", okListener).setCancelBtn("取消", new DialogInterface.OnClickListener() {
            @Override
    ...
    public static void requestPermissionsResult(final Activity activity, final int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode < 0 || requestCode >= requestPermissions.length) {
            ...
            ToastUtils.onToast("illegal requestCode:" + requestCode);
            return;
        }
    ...
    public static ArrayList<String> getNoGrantedPermission(Activity activity, boolean isShouldRationale) {
        ...
        for (int i = 0; i < requestPermissions.length; i++) {
            ...
            try {
                ...
                ToastUtils.onToast("please open those permission");
                Log.e(TAG, "RuntimeException:" + e.getMessage());
                return null;
            }
