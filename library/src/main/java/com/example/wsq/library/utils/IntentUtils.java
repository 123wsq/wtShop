...
public final class IntentUtils {
    ...
    public static void onStartActivity(Activity context, Class activity, Map<String, Object> param) throws Exception {

        if (context != null && activity != null) {
            Intent intent = new Intent(context, activity);
            onGetIntentData(intent, param);
            context.startActivity(intent);
        }
    }

    private static void onGetIntentData(Intent intent, Map<String, Object> param) throws Exception {
...
//        Intent intent = new Intent("android.intent.action.CALL", Uri.parse(phoneNumber.startsWith("tel:")? phoneNumber : "tel:" + phoneNumber));
        Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse(phoneNumber.startsWith("tel:") ? phoneNumber : "tel:" + phoneNumber));
        return getIntent(intent, isNewTask);
    }
    ...
    public static Intent getEmailIntent(String email) {
        ...
        Log.e("邮件", "mailto:" + email);
        // ULocale.Category(android.intent.category.DEFAULT);
        data.setData(Uri.parse(email.startsWith("mailto") ? email : "mailto:" + email));
