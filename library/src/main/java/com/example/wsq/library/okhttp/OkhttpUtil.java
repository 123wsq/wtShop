...
/**
    ...
    public static void okHttpUploadFiles(String url, List<Map<String, Object>> files, Map<String, String> paramsMap, CallBackUtil callBack) {
        okHttpUploadFiles(url, files, paramsMap, null, callBack);
    }
     ...
     * @param callBack
     */
    public static void okHttpUploadFiles(String url, List<Map<String, Object>> files, Map<String, String> paramsMap, Map<String, String> headerMap, CallBackUtil callBack) {
        new RequestUtil(METHOD_POST, url,paramsMap, files,  headerMap, callBack).execute();
    }
