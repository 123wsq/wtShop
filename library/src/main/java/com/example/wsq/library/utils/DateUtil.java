...
public final class DateUtil {
    ...
    public static final String DATA_FORMAT_6 = "MM-dd";
     ...
     * @param laterFormat  转换后的格式
     * @return
     */
    public static String onStrFormatToStrFormat(String str, String beforeFormat, String laterFormat){

        SimpleDateFormat format1 = new SimpleDateFormat(beforeFormat);
        SimpleDateFormat format2 = new SimpleDateFormat(laterFormat);
        try {
